...
wrap.css({marginLeft:_23f.outerWidth(),marginRight:_240.outerWidth()+tool.outerWidth(),left:0,width:"auto"});
}else{
_23f.hide();
_240.hide();
tool.css("right",0);
wrap.css({marginLeft:0,marginRight:tool.outerWidth(),left:0,width:"auto"});
wrap.scrollLeft(0);
}
};
function _244(_245){
