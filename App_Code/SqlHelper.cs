...
namespace ZBT.DateBase
{
    ...
    public sealed class SqlHelper
    {
       ...
       /// <summary>
        ...
        /// <summary>
        /// 执行指定数据库连接字符串的命令,直接提供参数值,返回DataTable.
        /// </summary>
        /// <remarks>
        /// 此方法不提供访问存储过程输出参数和返回值.
        /// 示例: 
        ...
        #region ExecuteDataRow方法


        /// <summary>
        /// 执行指定数据库连接字符串的命令,返回DataRow.
        /// </summary>
        /// <remarks>
        /// 示例:  
        ...
        /// <param name="commandType">命令类型 (存储过程,命令文本或其它)</param>
        /// <param name="commandText">存储过程名称或T-SQL语句</param>
        /// <returns>返回一个包含结果集的DataRow</returns>
        ...
        /// <summary>
        /// 执行指定数据库连接字符串的命令,直接提供参数值,返回DataRow.
        /// </summary>
        /// <remarks>
        /// 此方法不提供访问存储过程输出参数和返回值.
        /// 示例: 
        ...
        /// <summary>
        /// 执行指定数据库连接对象的命令,指定存储过程参数,返回DataRow.
        /// </summary>
        /// <remarks>
        /// 示例:  
        ...
        /// <summary>
        /// 执行指定数据库连接对象的命令,指定参数值,返回DataRow.
        /// </summary>
        /// <remarks>
        /// 此方法不提供访问存储过程输入参数和返回值.
        /// 示例.:  
        ...
        /// <summary>
        /// 执行指定事务的命令,指定参数,返回DataRow.
        /// </summary>
        /// <remarks>
        /// 示例:  
        ///  DataRow DR = ExecuteDataTable(trans, CommandType.StoredProcedure, "GetOrders", new SqlParameter("@prodid", 24));
        /// </remarks>
        /// <param name="transaction">事务</param>
        /// <param name="commandType">命令类型 (存储过程,命令文本或其它)</param>
        /// <param name="commandText">存储过程名或T-SQL语句</param>
        ...
        #endregion ExecuteDataRow数据集命令结束
